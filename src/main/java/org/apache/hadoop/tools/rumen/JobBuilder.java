...
public class JobBuilder {
	...
	private Map<String, LoggedTask> reduceTasks = new HashMap<String, LoggedTask>();
	private Map<String, LoggedTask> otherTasks = new HashMap<String, LoggedTask>();

	private Map<String, LoggedTaskAttempt> attempts = new HashMap<String, LoggedTaskAttempt>();
	 ...
	 */
	private final static Pattern taskAttemptIDPattern =	Pattern.compile(".*_([0-9]+)");
